...
//        log.info("turnoverlist:{}",StringUtils.join(turnoverList, ","));
    ...
    public OrderReportVO getOrdersStatistics(LocalDate begin, LocalDate end) {
        ...
        List<Integer> dailyCompletedOrderList = new ArrayList<>();
        for (LocalDate localDate : dateList) {
            LocalDateTime beginTime = LocalDateTime.of(localDate, LocalTime.MIN);
            LocalDateTime endTime = LocalDateTime.of(localDate, LocalTime.MAX);
            Map map = new HashMap<>();
            ...
            Integer dailyOrder = orderMapper.countByMap(map);
            dailyOrder = dailyOrder == null ? 0 : dailyOrder;
            dailyOrderList.add(dailyOrder);

            map.put("status", Orders.COMPLETED);
            Integer dailyCompletedOrder = orderMapper.countByMap(map);
            dailyCompletedOrder = dailyCompletedOrder == null ? 0 : dailyCompletedOrder;
            dailyCompletedOrderList.add(dailyCompletedOrder);
        }
        ...
        return OrderReportVO.builder()
                ...
                .validOrderCountList(StringUtils.join(dailyCompletedOrderList, ","))
